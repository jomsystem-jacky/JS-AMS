"use strict";
// Class definition
const tableName = "itemCategory_datatable";
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/ItemManagement/Configuration/ItemCategory/Edit?id=" + row.id + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
