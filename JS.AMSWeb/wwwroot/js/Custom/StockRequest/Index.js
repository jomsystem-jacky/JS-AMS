"use strict";
// Class definition
const tableName = "stock_request_datatable";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Inventory/StockRequest/GetAllStockRequests",
                        dataType: 'json',
                        params: {
                            "no": "",
                            "branchId": "",
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Inventory/StockRequest/Edit?id=" + row.requestId + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
