"use strict";
// Class definition
const tableName = "corporate_client_datatable";
const searchField = "SearchCompanyName";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Client/CorporateClient/GetAllCorporateClient",
                        dataType: 'json',
                        params: {
                            "name": "",
                            "debtorId": "",
            ...
            columns: [
                ...
                {
                    field: 'buisnessRegistrationNumber',
                    title: 'BRN',
                    sortable: false,
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Client/CorporateClient/Edit?id=" + row.corporateId + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
