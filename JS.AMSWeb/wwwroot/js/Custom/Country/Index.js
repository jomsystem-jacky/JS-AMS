"use strict";
// Class definition
const tableName = "country_datatable";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Administration/AreaManagement/Country/GetAllCountries",
                        dataType: 'json',
                        params: {
                            "name": "",
                        },
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Administration/AreaManagement/Country/Edit?id=" + row.id + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
