"use strict";
// Class definition
const tableName = "stock_count_datatable";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Inventory/StockCount/GetAllStockCounts",
                        dataType: 'json',
                        params: {
                            "no": "",
                            "branchId": "",
            ...
            columns: [
                ...
                {
                    field: 'stockCountDate',
                    title: 'Date',
                    type: 'date',
                    format: 'MM/DD/YYYY',
                    sortable: true,
                    template: function (row) {
                        const date = new Date(row.stockCountDate);
                ...
                },
                {
                    ...
                    template: function (row) {
                        ...
                        return '<span class="label font-weight-bold label-lg ' + status[row.stockCountStatus].class + ' label-inline">' + status[row.stockCountStatus].title + '</span>';
                    },
                },
                {
                    field: 'createdBy',
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Inventory/StockCount/Edit?id=" + row.stockCountId + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
