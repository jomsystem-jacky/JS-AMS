"use strict";
// Class definition
const tableName = "region_datatable";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Administration/AreaManagement/Region/GetAllRegions",
                        dataType: 'json',
                        params: {
                            "name": "",
                            "companyId": "",
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Administration/AreaManagement/Region/Edit?id=" + row.id + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
