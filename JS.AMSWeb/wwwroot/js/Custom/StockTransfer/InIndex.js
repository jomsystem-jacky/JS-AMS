"use strict";
// Class definition
const tableName = "stock_transfer_in_datatable";
        ...
        var datatable = $('#' + tableName).KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        method: "POST",
                        url: "/Inventory/StockTransferIn/GetTransferIn",
                        dataType: 'json',
                        params: {
                            "no": "",
                            "fromBranchId": "",
                ...
                },
                {
                    ...
                    template: function (row) {
                        return "<div class='dropdown dropdown-inline'/>"
                            + "<a href='/Inventory/StockTransferIn/Edit?id=" + row.id + "' class='btn btn-sm btn-clean btn-icon mr-2' title='View details'>"
