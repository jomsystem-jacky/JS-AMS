...
{
	public class TicketHistoryPageViewModel
    {
        public X.PagedList.IPagedList<TicketHistoryViewModel> Listing { get; set; }
        public UpdateTicketStatusViewModel UpdateTicketStatusDTO { get; set; }
