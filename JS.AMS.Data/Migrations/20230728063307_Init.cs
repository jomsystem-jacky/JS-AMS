        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IcPassport = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_UserAccount_Count", x => x.Count);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccessInfoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAccountAccess_AccessInfo_AccessInfoId",
                        column: x => x.AccessInfoId,
                        principalTable: "AccessInfo",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserAccountAccess_UserAccount_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAccountAccess_AccessInfoId",
                table: "UserAccountAccess",
                column: "AccessInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAccountAccess_UserAccountId",
                table: "UserAccountAccess",
